...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'flob.menu_extension' => 'getFlob_MenuExtensionService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'ppro', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_70f2f3376617cfb994e242a391d3b913af1091d1db7c9fb42ea63097c58153d5');
    ...
    /**
     * Gets the 'flob.menu_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Flob\Bundle\FoundationBundle\Twig\MenuExtension A Flob\Bundle\FoundationBundle\Twig\MenuExtension instance.
     */
    protected function getFlob_MenuExtensionService()
    {
        return $this->services['flob.menu_extension'] = new \Flob\Bundle\FoundationBundle\Twig\MenuExtension($this->get('twig'), $this->get('knp_menu.helper'), $this->get('knp_menu.matcher'), 'FlobFoundationBundle:Menu:foundation_breadcrumb.html.twig');
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:sliding.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 25));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'FlobFoundationBundle:Form:foundation_form_div_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'FlobFoundationBundle:Form:foundation_form_div_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('flob.menu_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/florianbelhomme/flob-foundation-bundle/Resources/views'), 'FlobFoundation');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b9e53c210e48fca942f59e34bc8da2a254467e2d');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56df50a87a8a66.74574749')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FlobFoundationBundle' => 'Flob\\Bundle\\FoundationBundle\\FlobFoundationBundle',
            ...
            'secret' => 'b9e53c210e48fca942f59e34bc8da2a254467e2d',
            'locale' => 'en',
            ...
            'kernel.secret' => 'b9e53c210e48fca942f59e34bc8da2a254467e2d',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'FlobFoundationBundle:Form:foundation_form_div_layout.html.twig',
            ),
            ...
            'flob.menu_extension.template' => 'FlobFoundationBundle:Menu:foundation_breadcrumb.html.twig',
